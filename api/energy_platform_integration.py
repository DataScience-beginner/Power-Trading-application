...
from excel_consumption_service.api.router import router as energy_platform_router
...
def init_energy_platform_db():
    ...
    print("🗄️  Initializing Energy Platform database...")
    ...
    try:
        ...
        print(f"⚠️  Seed data error (may already exist): {e}")
    finally:
        db.close()
