...
- V0 lineage/semantic limitations disclosed.
- Audit and decision records created for explanations.
- No arbitrary SQL, hidden reasoning, forecast, mutation, bid, or trade.
